namespace Hub.Migrations
{
    ...
    public partial class OverrideConventionForGigAndGenres : DbMigration
    {
        public override void Up()
        {
            ...
            DropForeignKey("dbo.Gigs", "Gengre_Id", "dbo.Genres");
            DropIndex("dbo.Gigs", new[] { "Artist_Id" });
            DropIndex("dbo.Gigs", new[] { "Gengre_Id" });
            ...
            AlterColumn("dbo.Gigs", "Gengre_Id", c => c.Byte(nullable: false));
            CreateIndex("dbo.Gigs", "Artist_Id");
            CreateIndex("dbo.Gigs", "Gengre_Id");
            AddForeignKey("dbo.Gigs", "Artist_Id", "dbo.AspNetUsers", "Id", cascadeDelete: true);
            AddForeignKey("dbo.Gigs", "Gengre_Id", "dbo.Genres", "Id", cascadeDelete: true);
        }
